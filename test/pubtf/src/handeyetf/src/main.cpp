...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        // send_opendoor_tf(br, 0,0, 0, 0, 0, 0, "world", "base");
        ...
        // send_opendoor_tf(br,0, -200, 375, 180, 0.000001, -135, "base", "grapper");
        // send_opendoor_tf(br, -4.692478,-43.987274,300,0,0,-45, "camera","bootle");

        send_opendoor_tf(br,-543.5, -202.7, -37, -180, 0.000001, 140, "base", "grapper");
        send_opendoor_tf(br, 20.112637,-39.651768,300,0,0,-45, "camera","bootle");
